var recreatie = require('../page_objects/recreatie.js');
...
describe('#recreatie', function () {
    this.timeout(30000);
    page = new recreatie();
    beforeEach(async function () {
        await page.visit('https://www.funda.nl/recreatie');
    });
    /* afterEach(function () {
         page.quit();
     }); */
    describe('Validation of input values for #recreatie #Postive', async function () {
    ...
    describe('Validation of input values for #recreatie #Negative', async function () {
    ...
    describe('Validation of input values for #recreatie #BoundaryValues', async function () {
