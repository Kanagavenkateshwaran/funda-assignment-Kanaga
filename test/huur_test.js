var huur = require('../page_objects/huur.js');
...
describe('#huur', function () {
    this.timeout(30000);
    page = new huur();
    beforeEach(async function () {
        await page.visit('https://www.funda.nl/huur');
    });
    /* afterEach(function () {
         page.quit();
     }); */
    describe('Validation of input values for #huur #Postive', async function () {
    ...
    describe('Validation of input values for #huur #Negative', async function () {
    ...
    describe('Validation of input values for #huur #BoundaryValues', async function () {
